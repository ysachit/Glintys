...
<body>
<div class="shout_box">
<div class="header" onClick="">Name of Friend<div class="close_btn">&nbsp;</div></div>
  <div class="toggle_chat">
  <div class="message_box">
    </div>
    <div class="user_info">
   <input name="shout_message" id="shout_message" type="text" placeholder="Type Message" maxlength="100" /> 
    </div>
    </div>
</div> 

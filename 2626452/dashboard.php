...
?>	
        ...
        <section id="main" class="column">
            ...
            <h4 style="font-size:18px; color:#0c9;" align="center">THANKS ! You are my creater.Welcome</h4>
                ...
                <div class="module_content">
                   ...
                   <div class="graph_today">
                     ...
                     <div class="graph_previous">
                        <p class="graph_day"></p>
						<p class="graph_count"><?php  ?></p>
						<p class="graph_type"></p>
					  </div>   
                   </article>
                     <?php 
					 $date_me =date("Y-m-d"); 
					$cw= mysql_query("SELECT * FROM user_details WHERE join_date='$date_me'");
					$no = MYSQL_NUMROWS($cw);
